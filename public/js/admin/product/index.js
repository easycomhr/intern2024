        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.success) {
                    ...
                    $('input[name="pre_type_id"]').val(data.pre_type_id);
                    $('input[name="quantity"]').val(data.quantity);
                    $('input[name="ingredient"]').val(data.ingredient);
                    $('input[name="uses"]').val(data.uses);
                    $('input[name="user_manual"]').val(data.user_manual);
                    $('input[name="important_note"]').val(data.important_note);
                    $('input[name="preserve"]').val(data.preserve);
